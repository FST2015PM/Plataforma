...
function ChartsFactory() {
    this.createLabel = function(container, mainText, secondaryText) {
        $("#"+container).append("<div class='col-md-12'><h1>"+mainText+"<small>"+secondaryText+"</small></h1></div>");
    };

    this.createBarChart = function(container, data, bType) {
    ...
    this.createLineChart = function(container, data) {
        var ctitle = data.title || "";
        var xAxisTitle = data.xAxisTitle || "";
        var yAxisTitle = data.yAxisTitle || "";
        var cats = data.categories || [];
    ...
    this.createGauge = function(container, title, val, min, max, unit, starth, startw) {
    ...
    this.createBubbleChart = function(container, data, labelField) {
        var ctitle = data.title || "";
        var xAxisTitle = data.xAxisTitle || "";
        var yAxisTitle = data.yAxisTitle || "";
    ...
    this.createScatterChart = function(container, data) {
        var ctitle = data.title || "";
        var xAxisTitle = data.xAxisTitle || "";
        var yAxisTitle = data.yAxisTitle || "";
        var values = data.series[0].values;
    ...
    this.createChart = function(container, data, engine, options) {
